        ...
        <div>
          <div className='script-form-frame'>
            ...
            <div className='script-form-fields'>
              <input onChange={this.updateDrugName} defaultValue={this.state.currentDrug} />
          ...
          <div className='script-form-frame'>
            <h3>Dosage</h3>
            <div className='script-form-fields'>
              <input className='dosageInput' onChange={this.handleDoseAmount} defaultValue={this.state.dosageAmt} />
